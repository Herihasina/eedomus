    ...
    $.widget("nd2.tabs", {
        ...
        _create: function() {
            ...
            el.on("click", ".nd2Tabs-nav-item:not('.nd2Tabs-active')", function(e) {
                e.preventDefault();
                _self.switchTabWithoutTransition($(this), $(this).data('tab'), $(".nd2Tabs-nav-item").index($(this)[0]));
            });
        ...
        getActiveTab: function() {
          var _self = this;
          return _self.settings.activeTab;
        },
        ...
        switchTabWithoutTransition: function(obj, tabKey, toIdx) {
            var _self = this;

            if (tabKey == _self.settings.activeTab) {
              return;
            }
